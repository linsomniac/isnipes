...
// SchemaChecksum is the u32 schemaChecksum value, computed once at
// init. Equals little-endian decode of SHA-256(schemaDescriptor)[0:4].
var SchemaChecksum uint32 = computeSchemaChecksum()
